...
| Project | What it does | Hardware envelope |
|---|---|---|
...
| [document-librarian](https://github.com/Drzymek92/document-librarian) | Offline document catalog for LLM agents — DuckDB, full-text search, local embeddings | _pending_ |
...
> **Envelopes are marked _pending_ deliberately.** They will be filled by a measurement probe on the
> reference machine, not estimated. A collection whose entire claim is a VRAM ceiling does not get
> to guess at the numbers.
